    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 sm:p-8 md:p-12">
          <button
            onClick={onClose}
            className="flex items-center justify-center hover:opacity-70 transition-opacity" //p-2 
          ...
          >
            <svg
              ...
              className="w-4 h-4 fill-black" //sm:w-8 sm:h-8 md:w-[34px] md:h-[28px] 
            >
          ...
          <nav className="flex flex-col space-y-8 sm:space-y-10"> {/* md:space-y-12 lg:space-y-16 */}
            ...
            <div className="group">
              <Link
                to="/"
                onClick={onClose}
                className="text-black font-jost text-xl font-normal leading-normal uppercase hover:opacity-70 transition-opacity block" //sm:text-2xl md:text-3xl
              >
                home
              </Link>
            </div>
            ...
            <div className="group relative">
              <Link
                ...
                onClick={onClose}
                className="text-black font-jost text-xl font-normal leading-normal uppercase hover:opacity-70 transition-opacity block pl-6 sm:pl-8" //sm:text-2xl md:text-3xl
              >
                signature collection
              </Link>
              {/* Horizontal line */}
              <div className="absolute left-0 top-1/2 -translate-y-1/2 w-4 h-0.5 bg-black opacity-60 group-hover:opacity-100 transition-opacity" /> {/* sm:w-5 md:w-6 */}
            </div>
